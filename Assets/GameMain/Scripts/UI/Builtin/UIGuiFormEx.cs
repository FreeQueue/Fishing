...
namespace Fishing
{
    public class UGuiFormEx : UGuiForm
    {
        ...
        protected override void OnClose(bool isShutdown, object userData)
        {
            ...
            {
                ReferencePool.Release(inputRegister);
                inputRegister = null;
            }
        }
        ...
        public void Register(EnumInput enumInput, Action action)
        {
            if(inputRegister==null)
            {
                inputRegister = InputRegister.Create(this);
            }
            inputRegister.Register(enumInput,action);
        }
        public void Unregister(EnumInput enumInput)
        {
            ...
            inputRegister.Unregister(enumInput);
        }
        public void UnregisterAll()
        {
            ...
            inputRegister.UnRegisterAll();
        }
        public void InputSetActive(bool value)
        {
            if(inputRegister==null)
            {
                return;
            }
            inputRegister.SetActive(value);
        }
    }
}
