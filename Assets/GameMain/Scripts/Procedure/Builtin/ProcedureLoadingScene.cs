...
namespace Fishing
{
    public class ProcedureLoadingScene : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            m_UILoadFormSerialID= GameEntry.UI.OpenUIForm(EnumUIForm.UILoadForm);
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Type procedureType = Type.GetType(string.Format("Fishing.{0}", sceneData.Procedure));
        ...
        protected override void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
            ...
            loadingSceneId = -1;
            GameEntry.UI.CloseUIForm((int)m_UILoadFormSerialID);
