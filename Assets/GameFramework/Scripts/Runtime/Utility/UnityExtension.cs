...
public static class UnityExtension
{
    ...
    public static Vector2 ToVector2Y(this Vector3 vector3)
    {
    ...
    /// <param name="vector3">要转换的 Vector3。</param>
    /// <returns>转换后的 Vector2。</returns>
    public static Vector2 ToVector2Z(this Vector3 vector3)
    {
    ...
    public static Vector3 ToVector3Y(this Vector2 vector2)
    {
    ...
    /// <returns>转换后的 Vector3。</returns>
    public static Vector3 ToVector3Y(this Vector2 vector2, float y)
    {
        return new Vector3(vector2.x, y, vector2.y);
    }
    /// <summary>
    /// 取 <see cref="Vector2" /> 的 (x, y) 和给定参数 z 转换为 <see cref="Vector3" /> 的 (x, y, 参数 z)。
    /// </summary>
    /// <param name="vector2">要转换的 Vector2。</param>
    /// <param name="z">Vector3 的 z 值。</param>
    /// <returns>转换后的 Vector3。</returns>
    public static Vector3 ToVector3Z(this Vector2 vector2, float z)
    {
    ...
    {
        Vector3 vector = lookAtPoint2D.ToVector3Y() - transform.position;
        vector.y = 0f;
